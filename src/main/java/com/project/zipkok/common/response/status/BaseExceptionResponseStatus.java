...
public enum BaseExceptionResponseStatus implements ResponseStatus {
    ...
    INVALID_RENTAL_PRICE_FORMAT(8006, HttpStatus.BAD_REQUEST.value(), "거래 타입은 PURCHASE, MONTHLY, YEARLY 중 하나여야 함"),
    INVALID_ESTATE_TYPE_FORMAT(80062, HttpStatus.BAD_REQUEST.value(), "매물 타입은 ONEROOM, TWOROOM, APARTMENT, OFFICETELL 중 하나여야 함"),
