...
public class KokFixture {
    ...
    static {
        List<CheckedHighlight> list = new ArrayList<>();
        list.add(DUMMY_CHECKED_HIGHLIGHT);

        ReflectionTestUtils.setField(KOK_01, "kokId", 1L);
        ReflectionTestUtils.setField(KOK_01, "realEstate", DUMMY_REALESTATE);
        ...
        ReflectionTestUtils.setField(KOK_01, "checkedHighlights", list);
